...
{r, echo=FALSE, fig.cap="Nubosidad"}
knitr::include_graphics("INPUT\mapas\dias_niebla.png")

{r, echo=FALSE, fig.cap="Horas de insolación"}
knitr::include_graphics("INPUT/mapas/horas_insolacion.png")

{r, echo=FALSE, fig.cap="Índice de vegetación"}
knitr::include_graphics("INPUT/mapas/indice_vegetacion.png")
