...
# Nose que hacer con esto Introducción
...
## 3.1 Búsqueda de datos. Mapas

### 3.1.1 Índice anual de enfermedades de piel y subcutáneas por comunidades autónomas
...
### 3.1.2 Zonas verdes distribuidas por comunidades autónomas
...
```{r Zonas-Verdes-CCAA, eval=FALSE, include=FALSE}
library(greenR)
...
### 3.1.3 Variación meteorológica respectiva a radiación solar
