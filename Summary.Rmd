...
Finalmente, creamos un dataframe con los datos resultantes que vamos a analizar.
...
Para terminar, visualizamos los datos finales en un dataframe.

```{Visualización-datos-radiación}
